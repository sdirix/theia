...
- `@theia/core/shared/...`
    ...
    - `@lumino/commands` (from [`@lumino/commands@^2.3.0`](https://www.npmjs.com/package/@lumino/commands))
    - `@lumino/coreutils` (from [`@lumino/coreutils@^2.1.2`](https://www.npmjs.com/package/@lumino/coreutils))
    - `@lumino/domutils` (from [`@lumino/domutils@^2.0.1`](https://www.npmjs.com/package/@lumino/domutils))
    - `@lumino/dragdrop` (from [`@lumino/dragdrop@^2.1.4`](https://www.npmjs.com/package/@lumino/dragdrop))
    ...
    - `@lumino/signaling` (from [`@lumino/signaling@^2.1.2`](https://www.npmjs.com/package/@lumino/signaling))
    - `@lumino/virtualdom` (from [`@lumino/virtualdom@^2.0.1`](https://www.npmjs.com/package/@lumino/virtualdom))
    - `@lumino/widgets` (from [`@lumino/widgets@2.3.2`](https://www.npmjs.com/package/@lumino/widgets/v/2.3.2))
